...
Donate link: 
Tags: braintree, braintree gateway, braintree plugin, braintree payments, payment processing, woocommerce, payment gateway, 3DS, 3D-Secure, 3D Secure, threeDSecure, woocommerce subscriptions, payment gateways, paypal, donations, subscriptions, braintree subscriptions, payment forms, wordpress payments, donation, recurring donations, v.zero, saq a
...
= Free Version =
<p>This plugin allows you to test all of the functionality available by signing up for a <a target="_blank" href="https://www.braintreepayments.com/sandbox">Braintree Sandbox</a> account.</p>

= Pro Version =
<p>Once you are ready to accept live payments, you can purchase the <a target="_blank" href="https://wordpress.paymentplugins.com/product-category/braintree-plugins/">Pro Version</a></p>
...
= Custom Form Demos =
Click <a target="_blank" href="https://support.paymentplugins.com/hc/en-us/articles/115001527088-Custom-Forms">HERE</a> to see live demos of the custom payment forms.
...
For more information or questions, please email <a href=”mailto:support@paymentplugins.com”>support@paymentplugins.com</a> or read through our detailed <a target="_blank" href="https://support.paymentplugins.com">documentation</a>.


== Frequently Asked Questions ==

= How can I found out more? = 
Please read our <a target="_blank" href="https://support.paymentplugins.com">documentation</a> which covers all the plugin functionality. 
...
5. Additional WooCommerce Settings. 
6. Donation Settings
7. Debug Log
8. Customize messages
9. Select a custom form design
10. Manage donations
11. Build in subscription functionality
...
== Upgrade Notice ==
= 2.5.4 = 
Warning! This version is a major update. For merchants that have a license, once you click update now, refresh your page and the pro version will be downloaded to your site and then you will be prompted to activate the Pro plugin. Payment Plugins is now hosting the Pro version on their own servers and the Wordpress.org repo will be used to demo new functionality via the Braintree Sandbox. If you do not have <strong>update now</strong> enabled on your Wordpress site due to permissions, you can click <strong><a style="font-size: 18px" href="https://s3-us-west-1.amazonaws.com/woo-payment-gateway/woo-payment-gateway-pro.zip">HERE</a></strong> to download the latest version of Pro and upload it. If you have any questions before installing the new version or experience any issues, please contact support@paymentplugins.com.<ol style="color: #fff !important">New In 2.5.4<li>Apple Pay</li><li>Advanced fraud tools</li><li>Payment method display customization</li><li>Improved subscription functionality</li><li>Donation management</li></ol>
= 2.5.3 = 
