...
class WebhookTesting
{
	...
	public static function sampleNotification( $kind, $id, $subjectXml = null )
	{
		$payload = base64_encode( self::_sampleXml( $kind, $id, $subjectXml ) ) . "\n";
	...
	private static function _sampleXml( $kind, $id, $subjectXml = null )
	{
		if ( ! $subjectXml ) {
			switch ($kind) {
